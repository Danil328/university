...
namespace Test
{
    class Program
    {
        //Western Digital WD Blue 1 TB (WD10EZEX): 1Тб, Latency 4ms, 7200rpm, write/read speed 150/150Мб/с
        //G Skill F4-3000C15-8GVGB x2: 16GB, 3000Мгц, Latency 70-80ns, write/read speed 27000/27000Мб/с
        static void Main(string[] args)
        {
            var path = "E:\\LAB1\\data1.txt";
